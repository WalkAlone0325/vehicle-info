...
const selectPickerProps = {
  ...
  modelValue: uni_modules_wotDesignUni_components_common_props.makeRequiredProp([String, Number, Boolean, Array]),
  /** 选择器数据，一维数组 */
  columns: uni_modules_wotDesignUni_components_common_props.makeArrayProp(),
  /** 单复选选择器类型 */
  type: uni_modules_wotDesignUni_components_common_props.makeStringProp("checkbox"),
  /** 选项对象中，value 对应的 key */
  ...
  /** 可搜索（目前只支持本地搜索） */
  filterable: uni_modules_wotDesignUni_components_common_props.makeBooleanProp(false),
  /** 搜索框占位符 */
  filterPlaceholder: String,
  /** 是否超出隐藏 */
  ellipsis: uni_modules_wotDesignUni_components_common_props.makeBooleanProp(false),
  /** 重新打开是否滚动到选中项 */
  scrollIntoView: uni_modules_wotDesignUni_components_common_props.makeBooleanProp(true),
...
exports.selectPickerProps = selectPickerProps;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/wot-design-uni/components/wd-select-picker/types.js.map

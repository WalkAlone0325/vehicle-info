...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-select-picker/wd-select-picker.vue:210", "The type of displayFormat must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-select-picker/wd-select-picker.vue:223", "The type of beforeConfirm must be Function");
        }
      },
      {
        deep: true,
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        p: common_vendor.n(`wd-select-picker__cell ${_ctx.disabled && "is-disabled"} ${props.readonly && "is-readonly"} ${_ctx.alignRight && "is-align-right"} ${_ctx.error && "is-error"} ${_ctx.size && "is-" + _ctx.size}`)
      }), {

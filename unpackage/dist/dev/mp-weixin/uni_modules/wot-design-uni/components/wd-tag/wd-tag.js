    ...
    common_vendor.watch(
      ...
      (newValue) => {
        ...
        if (type.indexOf(newValue) === -1)
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-tag/wd-tag.vue:73", `type must be one of ${type.toString()}`);
        computeTagClass();
      },
      { deep: true, immediate: true }
    );
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/wot-design-uni/components/wd-tag/wd-tag.js.map

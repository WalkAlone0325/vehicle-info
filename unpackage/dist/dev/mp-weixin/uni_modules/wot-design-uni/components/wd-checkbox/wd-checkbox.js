  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    common_vendor.watch(
      ...
      (newValue) => {
        ...
        if (uni_modules_wotDesignUni_components_common_util.isDef(newValue) && type.indexOf(newValue) === -1)
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-checkbox/wd-checkbox.vue:94", `shape must be one of ${type.toString()}`);
      }
    );
    ...
    common_vendor.onBeforeMount(() => {
      if (props.modelValue === null)
        common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-checkbox/wd-checkbox.vue:137", "checkbox's value must be set");
    });
    function checkName() {
      checkboxGroup && checkboxGroup.children && checkboxGroup.children.forEach((child) => {
        if (child.$.uid !== proxy.$.uid && child.modelValue === props.modelValue) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-checkbox/wd-checkbox.vue:150", `The checkbox's bound value: ${props.modelValue} has been used`);
        }
      });
    }
    function toggle() {
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/wot-design-uni/components/wd-checkbox/wd-checkbox.js.map

    ...
    common_vendor.watch(
      ...
      (newValue) => {
        ...
        if (!newValue || type.indexOf(newValue) === -1)
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-radio/wd-radio.vue:102", `shape must be one of ${type.toString()}`);
      }
    );
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/wot-design-uni/components/wd-radio/wd-radio.js.map

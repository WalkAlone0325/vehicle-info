...
const uni_modules_wotDesignUni_components_composables_useUpload = require("../composables/useUpload.js");
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { startUpload, abort, chooseFile, UPLOAD_STATUS } = uni_modules_wotDesignUni_components_composables_useUpload.useUpload();
    common_vendor.watch(
      () => props.fileList,
      (val) => {
    ...
    common_vendor.watch(
      ...
      (val) => {
        if (val && val < uploadFiles.value.length) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:172", "[wot-design]Error: props limit must less than fileList.length");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:185", "The type of beforePreview must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:198", "The type of onPreviewFail must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:211", "The type of beforeRemove must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:224", "The type of beforeUpload must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:237", "The type of beforeChoose must be Function");
        }
      },
      {
        deep: true,
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-upload/wd-upload.vue:250", "The type of buildFormData must be Function");
        }
      },
      {
        deep: true,

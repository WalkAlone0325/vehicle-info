...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    common_vendor.watch(
      ...
      (target) => {
        ...
        if (type.indexOf(target) === -1) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-datetime-picker-view/wd-datetime-picker-view.vue:126", `type must be one of ${type}`);
        }
        updateValue();
      },
      { deep: true, immediate: true }
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-datetime-picker-view/wd-datetime-picker-view.vue:138", "The type of filter must be Function");
        }
        updateValue();
      },
      { deep: true, immediate: true }
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-datetime-picker-view/wd-datetime-picker-view.vue:149", "The type of formatter must be Function");
        }
        updateValue();
      },
      { deep: true, immediate: true }
    ...
    common_vendor.watch(
      ...
      (fn) => {
        if (fn && !uni_modules_wotDesignUni_components_common_util.isFunction(fn)) {
          common_vendor.index.__f__("error", "at uni_modules/wot-design-uni/components/wd-datetime-picker-view/wd-datetime-picker-view.vue:160", "The type of columnFormatter must be Function");
        }
        updateValue();
      },
      { deep: true, immediate: true }
    ...
    function correctValue(value) {
      ...
      if (!isDateType) {
        let [hour, minute] = (uni_modules_wotDesignUni_components_common_util.isString(value) ? value : value.toString()).split(":");
